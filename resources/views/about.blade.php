            ...
            <div class="general__container">
                <div class="main">
                    <div class="main__content">
                        <h1 class="title general__corbel-b ">{{__('asd.О компании')}}</h1>
                        <p class="subtitle general__corbel-r">{{__('asd.Наша компания была основана 15 сентября 2008 года. С первых дней работы мы стремимся к совершенству, которое является основой всего, что мы делаем.')}}  </p>
                        <div class="main__btns">
                            <a href="/projects" class="main__download">
                                <span class="general__corbel-r">{{__('asd.Скачать презентацию')}}
                ...
                <div class="company">
                    <div class="columns">
                        <h2 class="general__title" data-aos="fade-right">
                            <span class="line">{{__('asd.О нашей')}} </span>
                            <span class="pl">{{__('asd.компанииt')}}</span>
                        </h2>
                    ...
                    <div class="columns">
                        ...
                        <p class="subtitle general__euclid-l" data-aos="fade-up">{{__('asd.Мы не просто создаём проекты, мы создаем новые возможности. Строя объекты государственного масштаба, мы строим будущее. Мы заботимся об окружающей среде:')}} {{__('asd.Мы заботимся об окружающей среде: компания берет на себя полную ответственность за экологические аспекты, связанные со строительством и эксплуатацией зданий и инфраструктуры.')}}</p>
                        <a href="{{route('project')}}" class="link" data-aos="fade-up">
                            <span class="general__corbel-r pic__anima">{{__('asd.Проекты')}}</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="mission">
                    <div class="mission__row">
                        ...
                        <div class="mission__wrap">
                            ...
                            <div class="wrap" data-aos="fade-up">
                                <h2 class="title general__corbel-b">{{__('asd.Наша миссия')}}</h2>
                                <p class="subtitle general__euclid-m">{{__('asd.Мы внедряем в Узбекистане самые передовые технологии в строительстве и создаём современные дизайнерские решения.')}} {{__('asd.Опираясь на первоклассных работников, мы строим доступное жильё и промышленные здания на многие годы.')}}</p>
                            </div>
                        </div>
                        <div class="pic" data-aos="fade-down-left">
                    ...
                    <div class="mission__row">
                        ...
                        <div class="mission__wrap">
                            ...
                            <div class="wrap" data-aos="fade-up">
                                <h2 class="title general__corbel-b">{{__('asd.Наше видение')}}</h2>
                                <p class="subtitle general__euclid-m">{{__('asd.Создание лучшей в Средней Азии проектной компании, которая предоставляет возможность: - Обществу –повышать уровень жизни людей, задавая высокие стандарты в работе.')}} {{__('asd.- Клиентам – получать удовольствие от совместной деятельности, строить долгосрочные и открытые отношения.- Сотрудникам – постоянной рост как личностный так и профессиональный.')}}</p>
                            </div>
                        </div>
                        <div class="pic" data-aos="fade-down-left">
                            <div class="pic__img pic__anima">
                    ...
                    <div class="mission__row">
                        <div class="mission__wrap">
                            ...
                            <div class="wrap" data-aos="fade-up">
                                <h2 class="title general__corbel-b">{{__('asd.Наши ценности')}}</h2>
                                <p class="subtitle general__euclid-m">{{__('asd.С момента основания (ООО) «Discover Invest» 2008 года, мы работаем только с профессионалами. Наши специалисты, используют передовые технологии и инновационный подход в бизнесе.')}}{{__('asd.Независимо от времени и места деятельности мы остаёмся преданными нашим ценностям: персонал и безопасность, постоянное совершенствование и доверие наших клиентов')}}</p>
                            </div>
                        </div>
                        <div class="pic" data-aos="fade-down-left">
                            <div class="pic__img pic__anima">
