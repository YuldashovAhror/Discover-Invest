            ...
            <div class="general__container">
                <div class="company">
                    ...
                    <div class="columns">
                        ...
                        <p class="subtitle general__euclid-l" data-aos="fade-up">{{__('asd.Создавая наши проекты, мы создаем возможности. Строя объекты наших клиентов, мы строим будущее.')}} {{__('asd.Откройте для себя Discover Invest, чтобы разнообразить и сделать жизнь людей ярче, создавая уникальную архитектуру и дизайн.')}} {{__('asd.Мы заботимся об окружающей среде: компания берет на себя полную ответственность за экологические аспекты, связанные со строительством и эксплуатацией зданий и инфраструктуры.')}}</p>
                    ...
                    <div class="mission__row">
                        ...
                        <div class="mission__wrap">
                            ...
                            <div class="wrap" data-aos="fade-up">
                                ...
                                <p class="subtitle general__euclid-m">{{__('asd.Мы внедряем в Узбекистане самые передовые технологии в строительстве и создаём современные дизайнерские решения.')}} {{__('asd.Опираясь на первоклассных работников, мы строим доступное жильё и промышленные здания на многие годы, превосходя ожидания наших заказчиков.')}}</p>
                            </div>
                        </div>
                        <div class="pic" data-aos="fade-down-left">
                    ...
                    <div class="mission__row">
                        ...
                        <div class="mission__wrap">
                            ...
                            <div class="wrap" data-aos="fade-up">
                                ...
                                <p class="subtitle general__euclid-m">{{__('asd.Создавая уникальный архитектурный образ, возводить здания достойные истории.')}} {{__('asd.Быть предпочтительной инновационно-строительной компанией для наших партнеров и заказчиков, а для сотрудников – Гордостью.')}}</p>
                            </div>
                        </div>
                        <div class="pic" data-aos="fade-down-left">
                            <div class="pic__img pic__anima">
                    ...
                    <div class="mission__row">
                        <div class="mission__wrap">
                            ...
                            <div class="wrap" data-aos="fade-up">
                                ...
                                <p class="subtitle general__euclid-m">{{__('asd.Независимо от времени и места деятельности мы остаёмся преданными нашим ценностям: персонал и безопасность, постоянное совершенствование и доверие наших клиентов.')}}</p>
                            </div>
                        </div>
                        <div class="pic" data-aos="fade-down-left">
                            <div class="pic__img pic__anima">
