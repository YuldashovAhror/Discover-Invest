            ...
            <div class="general__container">
                <div class="main">
                    <div class="main__content">
                        <h1 class="title general__corbel-b ">{{__('asd.Контакты')}}</h1>
                        <p class="subtitle general__corbel-r">{{__('asd.Оставьте свои контакты, заполнив текущую форму, и мы свяжемся с вами в ближайшее время.')}}</p>
        ...
        <section class="section__contacts">
                ...
                <div class="contacts" id="contacts">
                    <div class="contacts__column contacts__column-left">
                        <h2 class="title general__title">
                            <span class="line">{{__('asd.Как мы можем')}}</span>
                            <span class="pl">{{__('asd.помочь')}}?</span>
                        </h2>
                        <p class="subtitle general__euclid-l">{{__('asd.Оставьте свои контакты, заполнив текущую форму, и мы свяжемся с вами в ближайшее время.')}}</p>
                        <address>
                            <div class="box">
                                ...
                                <div class="box__content">
                                    <h4 class="box__name general__euclid-m">{{__('asd.Адрес')}}</h4>
                                    <p class="box__text general__euclid-r">{{__('asd.Узбекистан, Ташкент, Национальный парк Узбекистана имени Алишера Навои')}}
                                    </p>
                                </div>
                            </div>
                            <div class="box">
                                ...
                                <div class="box__content">
                                    <h4 class="box__name general__euclid-m">{{__('asd.Телефон')}}</h4>
                            ...
                            <div class="box">
                                ...
                                <div class="box__content">
                                    <h4 class="box__name general__euclid-m">{{__('asd.Время работы')}}</h4>
            ...
            <div class="general__container">
                <div class="contacts__bottom">
                    <p class="txt general__euclid-l">© 2022 Discover Invest. {{__('asd.Все права защищены.')}}</p>
