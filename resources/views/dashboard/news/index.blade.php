                        ...
                        @foreach($news as $new)
                            <tr>
                                ...
                                <td class="px-6 py-2 text-sm" style="width: 130px;">
                                    ...
                                    <div class="mt-1">
                                        <button class="btn btn-danger " type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{$new->id}}" data-bs-original-title="" title=""><i class="lni lni-trash"></i></i></button>
                                    </div>
                                </td>
