                        ...
                        @foreach($timelines as $timeline)
                            <tr>
                                ...
                                <td class="px-6 py-2 text-sm" style="width: 130px;">
                                    ...
                                    <div class="mt-1">
                                        <button class="btn btn-danger " type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{$timeline->id}}" data-bs-original-title="" title=""><i class="lni lni-trash"></i></i></button>
                                    </div>
                                </td>
                                <div class="modal fade" id="exampleModalCenter{{$timeline->id}}" tabindex="-1" aria-labelledby="exampleModalCenter" style="display: none;" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{route('dashboard.timeline.destroy', $timeline->id)}}" method="post">
                                                @csrf
                                                @method('delete')
